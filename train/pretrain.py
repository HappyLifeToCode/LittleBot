...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniBot Pretraining (Single GPU)")
    ...
    parser.add_argument("--swanlab_project", type=str, default="MiniBot-Pretrain", help="swanlab项目名")
    ...
    if args.use_swanlab:
        import swanlab
        swanlab.login(api_key="x18lEopjAkQe6biAz9lex")
    ...
    if args.from_weight != 'none' and os.path.exists(args.from_weight):
        ...
        model = MiniBotForCausalLM.from_pretrained(args.from_weight)
    else:
